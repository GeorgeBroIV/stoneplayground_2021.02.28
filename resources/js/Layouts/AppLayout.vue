    ...
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
          <div class="sticky">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="flex items-center px-4">
                            <div v-if="$page.props.jetstream.managesProfilePhotos" class="flex-shrink-0 mr-3" >
                                <img class="h-10 w-10 rounded-full object-cover" :src="$page.props.user.profile_photo_url" :alt="$page.props.user.firstname" />
                            </div>

                            <div>
                                <div class="font-medium text-base text-gray-800">{{ $page.props.user.firstname }}</div>
            ...
            <!-- Page Heading -->
            <header class="bg-blue-50 shadow" v-if="$slots.header">
                <div align="center" class="max-w-7xl mx-auto py-2 px-4 sm:px-6 lg:px-8">
