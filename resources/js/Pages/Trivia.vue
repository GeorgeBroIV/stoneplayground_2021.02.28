					...
					<b-col sm="8">
						...
						<div id="triviaOptions" v-if="!triviaActive">
							...
							<div>
								...
								<div align="center" v-if="this.empty && !this.loadFailed" class="mt-0 mb-3 py-2 text-gray-700 bg-blue-100 w-50">
									<div class="mb-2 h5">
										Loading...
									</div>
								</div>

								<div align="center" v-if="this.loadFailed" class="mt-0 mb-3 py-2 text-gray-700 bg-blue-100 w-50">
									<div class="mb-2 h5">
								...
								<div class="mt-3">
									<b-button v-if="!this.empty || this.loadFailed" @click="startSurvey" variant="primary">
										Start Trivia
									</b-button>
								</div>
							</div>
